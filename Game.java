...
public class Game {
    ...
    public static void main(String[] args) {
        ...
        while (lives > 0) {
            ...
            char letter = guess.charAt(0);  //then we find a letter in a string using charAt
            ...
            lettersNotUsed = lettersNotUsed.replace(letter, '_'); // to show which letter is already used
            System.out.println("Letters not used: " + lettersNotUsed); // in the process of game by replacing it with a low dash
            System.out.println("--------------------------------------------"); // for more convenient choice from the letters left
