...
public class Game {
    ...
    //lives |||||| - to change this to numerals, simply 6, then descending
    //draw hangman
    //to make the design more attractive
    //to make an option to exit the game/to start new game
    //to display other comments besides "Right" and "Wrong letter. Try again!"
    ...
    public static void main(String[] args) {
        ...
        String[] words = new String[] {"mouse", "elephant", "koala", "rhino", "turtle", "penguin", "camel", "puma", "tiger", "pig", "dog", "jaguar", "cat", "hedgehog", "sheep", "goat", "squirrel", "kangaroo", "horse", "monkey", "hippo", "panda", "zebra", "giraffe", "rabbit", "snake", "cow", "leopard", "wolf", "alligator", "bear", "lion", "raccoon"};
